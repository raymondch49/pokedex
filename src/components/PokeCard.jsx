...
export default function PokeCard(props){
  ...
  async function fetchMoveData(move, moveUrl){ //the thing in storage is an object with the key as skill name and value as an object of skill name and description
    ...
    try {
      ...
      setSkill(skillData)   //Everytime skill state is changed, the modal is render cause the Skill is True
      c[move] = skillData
  ...
  //skill is object with the name and the description
